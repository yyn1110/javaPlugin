...
public class EcuserAccount implements Serializable {
	private static final long serialVersionUID = 0X8EAB0D3BCDA0AFA9L;
	...
	public String toString() {
		return "EcuserAccount [accountId=" + accountId + ", ecuserId=" + ecuserId + ", account=" + account + ", freezeAccount=" + freezeAccount + ", backCount=" + backCount + ", freezeBackCount=" + freezeBackCount + ", lastModifyDate=" + lastModifyDate + ", userName=" + userName + "]";
	}
}
