...
public class EcuserAccountAdd implements Serializable {
	private static final long serialVersionUID = 0X135AB74438A6CA72L;
	...
	public String toString() {
		return "EcuserAccountAdd [accountId=" + accountId + ", ecuserId=" + ecuserId + ", account=" + account + ", freezeAccount=" + freezeAccount + ", backCount=" + backCount + ", freezeBackCount=" + freezeBackCount + ", lastModifyDate=" + lastModifyDate + ", userName=" + userName + "]";
	}
}
