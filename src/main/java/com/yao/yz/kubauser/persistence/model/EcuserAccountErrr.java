...
public class EcuserAccountErrr implements Serializable {
	private static final long serialVersionUID = 0X84AC660AA4E3C3DCL;
	...
	public String toString() {
		return "EcuserAccountErrr [accountId=" + accountId + ", ecuserId=" + ecuserId + ", account=" + account + ", freezeAccount=" + freezeAccount + ", backCount=" + backCount + ", freezeBackCount=" + freezeBackCount + ", lastModifyDate=" + lastModifyDate + ", userName=" + userName + "]";
	}
}
