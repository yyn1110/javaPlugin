...
public class EcuserAccountOpen implements Serializable {
	private static final long serialVersionUID = 0XD4A1E1262155108FL;
	...
	public String toString() {
		return "EcuserAccountOpen [accountId=" + accountId + ", ecuserId=" + ecuserId + ", account=" + account + ", freezeAccount=" + freezeAccount + ", backCount=" + backCount + ", freezeBackCount=" + freezeBackCount + ", lastModifyDate=" + lastModifyDate + ", userName=" + userName + "]";
	}
}
