...
public class EcuserAccountUpdate implements Serializable {
	private static final long serialVersionUID = 0X9E3BD632258B9AF2L;
	...
	public String toString() {
		return "EcuserAccountUpdate [accountId=" + accountId + ", ecuserId=" + ecuserId + ", account=" + account + ", freezeAccount=" + freezeAccount + ", backCount=" + backCount + ", freezeBackCount=" + freezeBackCount + ", lastModifyDate=" + lastModifyDate + ", userName=" + userName + "]";
	}
}
