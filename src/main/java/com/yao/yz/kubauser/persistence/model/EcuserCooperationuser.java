...
public class EcuserCooperationuser implements Serializable {
	private static final long serialVersionUID = 0X040A3E8D813E3973L;
	...
	public String toString() {
		return "EcuserCooperationuser [id=" + id + ", platform=" + platform + ", outUserId=" + outUserId + ", loginName=" + loginName + ", realName=" + realName + ", nickName=" + nickName + ", mobile=" + mobile + ", telphone=" + telphone + ", email=" + email + ", birthday=" + birthday + ", originalParameter=" + originalParameter + ", kubaUserId=" + kubaUserId + ", addTime=" + addTime + ", status=" + status + ", gender=" + gender + ", userSafeKey=" + userSafeKey + "]";
	}
}
