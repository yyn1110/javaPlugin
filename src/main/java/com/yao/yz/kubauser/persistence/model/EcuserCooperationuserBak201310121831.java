...
public class EcuserCooperationuserBak201310121831 implements Serializable {
	private static final long serialVersionUID = 0X41046F6C860DE490L;
	...
	public String toString() {
		return "EcuserCooperationuserBak201310121831 [id=" + id + ", platform=" + platform + ", outUserId=" + outUserId + ", loginName=" + loginName + ", realName=" + realName + ", nickName=" + nickName + ", mobile=" + mobile + ", telphone=" + telphone + ", email=" + email + ", birthday=" + birthday + ", originalParameter=" + originalParameter + ", kubaUserId=" + kubaUserId + ", addTime=" + addTime + ", status=" + status + ", gender=" + gender + ", userSafeKey=" + userSafeKey + "]";
	}
}
