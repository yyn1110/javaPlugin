...
public class EcuserCustomer implements Serializable {
	private static final long serialVersionUID = 0X73CDC75058803A56L;
	...
	private String version; // type in db: varchar(50)
	private String channel; // type in db: varchar(50)
	private String partnerId; // type in db: varchar(100)
	private String privateCustoms; // type in db: varchar(300)
	private String privateCustomSex; // type in db: varchar(20)
	private Integer privateCustomRole; // type in db: int(2)
	private String privateCustomAgeGroup; // type in db: varchar(50)
	private String privateImage; // type in db: varchar(300)
	private Integer openRemind; // type in db: tinyint(2)
	private Integer popType; // type in db: tinyint(2)
	private String promoCode; // type in db: varchar(10)
	private String userType; // type in db: varchar(3)
	...
	public void setPrivateCustoms(String privateCustoms) {
		this.privateCustoms = privateCustoms;
	}

	public String getPrivateCustomSex() {
		return this.privateCustomSex;
	}
	public void setPrivateCustomSex(String privateCustomSex) {
		this.privateCustomSex = privateCustomSex;
	}

	public Integer getPrivateCustomRole() {
		return this.privateCustomRole;
	}
	public void setPrivateCustomRole(Integer privateCustomRole) {
		this.privateCustomRole = privateCustomRole;
	}

	public String getPrivateCustomAgeGroup() {
		return this.privateCustomAgeGroup;
	}
	public void setPrivateCustomAgeGroup(String privateCustomAgeGroup) {
		this.privateCustomAgeGroup = privateCustomAgeGroup;
	}
	...
	public void setOpenRemind(Integer openRemind) {
