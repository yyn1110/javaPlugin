...
public class EcuserCustomerFake implements Serializable {
	private static final long serialVersionUID = 0XA73B0981ABD0B337L;
	...
	private String salt; // type in db: varchar(50)
