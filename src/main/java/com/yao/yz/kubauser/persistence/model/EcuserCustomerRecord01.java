...
public class EcuserCustomerRecord01 implements Serializable {
	private static final long serialVersionUID = 0XEFA34662DE0F4AB9L;
	...
	public String toString() {
		return "EcuserCustomerRecord01 [id=" + id + ", modifyDate=" + modifyDate + ", modifyType=" + modifyType + ", modifyTypeName=" + modifyTypeName + ", modifyBefore=" + modifyBefore + ", modifyAfter=" + modifyAfter + ", operator=" + operator + ", operateIp=" + operateIp + ", ecUserId=" + ecUserId + "]";
	}
}
