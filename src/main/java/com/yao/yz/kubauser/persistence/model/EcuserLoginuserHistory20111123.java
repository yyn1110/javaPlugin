...
public class EcuserLoginuserHistory20111123 implements Serializable {
	private static final long serialVersionUID = 0XDFE28258963F3064L;
	...
	public String toString() {
		return "EcuserLoginuserHistory20111123 [token=" + token + ", userId=" + userId + ", userName=" + userName + ", loginTime=" + loginTime + ", expiredTime=" + expiredTime + ", userIp=" + userIp + ", logoutTime=" + logoutTime + ", isUse=" + isUse + ", sessionId=" + sessionId + "]";
	}
}
