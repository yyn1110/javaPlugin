...
public class Lotteryuser implements Serializable {
	private static final long serialVersionUID = 0XAB401041F0C52CF5L;
	...
	public String toString() {
		return "Lotteryuser [id=" + id + ", userName=" + userName + ", userId=" + userId + ", goodsName=" + goodsName + ", goodsId=" + goodsId + ", lotteryTime=" + lotteryTime + ", ip=" + ip + ", actType=" + actType + ", lotteryDate=" + lotteryDate + "]";
	}
}
