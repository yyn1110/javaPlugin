...
import com.yao.yz.kubauser.persistence.dao.EcuserCustomerBak201310121831Dao;
import com.yao.yz.kubauser.exception.UnitTestException;
import org.apache.log4j.Logger;
import org.junit.Test;
import org.springframework.beans.factory.annotation.Autowired;

public class EcuserCustomerBak201310121831Test extends AbstractTest {
	private static final Logger LOGGER = Logger.getLogger(EcuserCustomerBak201310121831.class);
	@Autowired
	private EcuserCustomerBak201310121831Dao dao;

	private void setObjVal(EcuserCustomerBak201310121831 sObj) {
		sObj.setEcUId(1);
	...
	public void testCase() throws UnitTestException {
		EcuserCustomerBak201310121831 objInsert = new EcuserCustomerBak201310121831();
		setObjVal(objInsert);

		LOGGER.info("+ [EcuserCustomerBak201310121831]");
		dao.insert(objInsert);
		Integer key = objInsert.getEcUserId();
		if (key == null || key == 0) {
			throw new UnitTestException("EcuserCustomerBak201310121831Test", "test of insert is failed");
		}
		LOGGER.info("	insert OK");

		EcuserCustomerBak201310121831 objSelect = dao.getEcuserCustomerBak201310121831ByKey(key);
		if (objSelect == null) {
			throw new UnitTestException("EcuserCustomerBak201310121831Test", "test of select is failed");
		}
		LOGGER.info("	select OK");

		Integer res = dao.update(objSelect);
		if (res == null || res == 0) {
			throw new UnitTestException("EcuserCustomerBak201310121831Test", "test of update is failed");
		}
		LOGGER.info("	update OK");

		Integer del = dao.delete(key);
		if (del == null || del == 0) {
			throw new UnitTestException("EcuserCustomerBak201310121831Test", "test of delete is failed");
		}
